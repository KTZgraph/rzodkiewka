...
class FileMager:
    ...
    @staticmethod
    def get_cve_output_filename(current_working_dir: str, cwe_code: str) -> str:
        dirname = f"{str(cwe_code)}.json"
        return os.path.join(
            current_working_dir, FileMager.GENERAL_OUTPUT_DIRNAME, dirname
        )
